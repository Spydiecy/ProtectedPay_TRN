        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a href="https://github.com/Spydiecy/protectedpay" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://discord.gg/protectedpay" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-indigo-500 dark:text-gray-400 dark:hover:text-indigo-400">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
